...
const FriendsChat: React.FC<FriendsChatProps> = ({ currentUserId }) => {
  ...
  const [messages, setMessages] = useState([
    ...
    { Friend: 'Friend 3', text: 'Goodbye from Friend 3' },
  ]);
  const currentMessages = messages.filter(message => message.Friend === selectedFriend);
