...
export default function PopUpGroups({ onOpen,onClose }: any) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-[50%] text-center">
                ...
                <div className='bg-gray-300 rounded-md flex justify-between items-center mb-2'>
                    <Groups name={'hzt'} />

                    <button className='mr-5 rounded-md font-medium text-white py-1 px-9 bg-green-600'>
                        Invit
                    </button>
                </div>
                <div className='bg-gray-300 rounded-md flex justify-between items-center mb-2'>
